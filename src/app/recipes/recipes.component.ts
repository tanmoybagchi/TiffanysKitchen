...
import { Ingredient, Recipe } from '@app/recipes/models';
import { SyncDatabaseCommand } from '@app/recipes/sync-database-command.service';
      ...
      matchedIngredients.forEach(ingredient => {
        ingredient.recipes.forEach(ingredientRecipe => {
          ...
          if (!recipeVM) {
            ...
            Object.copyMatchingProperties(recipeVM, ingredientRecipe);
